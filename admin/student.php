    ...
    <a href='index.php?insert_student' class='btn btn-success mx-5 my-2'>Insert student</a>
        ...
        <tbody>";
            ...
            while($row_data=mysqli_fetch_array($run_select)){
                ...
                $student_password=$row_data['student_password'];
            ...
            <td>$student_phone</td>
            <td>
            <a href='index.php?update_student=$student_id'><i class='fa-solid fa-pen-to-square'></i></a>
            <a href='index.php?delete_student=$student_id' class='ms-3 text-danger'><i class='fa-solid fa-trash'></i></a>
            </td>
            </tr>
            </tbody>
            </table>
