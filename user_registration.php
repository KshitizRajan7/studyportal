...
<body>
<h1 class='text-center bg-dark text-light'>User Registration</h1>
<div class='text-center'>
    <a href="teachers/teacher_registration.php" class='btn btn-info'>Click for Teacher Registration</a>
</div>
<h1 class="text-center text-success">Student registration</h1>
<div class="container-fluid m-auto w-50">
    <form action="" method='post' enctype='multipart/form-data'>
        ...
        <p class="small fw-bold mt-2 mb-5">Already Have an Account? <a href='user_login.php' class='text-decoration-none'>Sign In </a></p>
...
if(isset($_POST['student_submit'])){
    ...
    if($result){
        ...
        echo "<script>window.open('user_login','_self')'</script>";
    }}
}
?>